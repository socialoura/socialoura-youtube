      ...
      <section className="relative overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 lg:px-8 w-full">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-black tracking-tight sm:text-4xl md:text-5xl lg:text-6xl mb-6 sm:mb-8 leading-tight bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent">
              {t.hero.platform}
            </h1>
