  ...
  const content = {
    ...
    fr: {
      hero: {
        ...
        platform: 'TIKTOK',
        subtitle: 'Pas de bots. Pas de faux comptes. Seulement une vraie visibilité via notre réseau de partenaires privés — entièrement conforme aux politiques de la plateforme.',
        badges: [
